...
import fr.umlv.astar.AStar.AStarVertex;
...
public class AStarPath<V> implements AStarResult<V> {
	...
	/**
	 * Constructor of an astar path. The path is reprensented by its last
	 * vertex. Each vertex get a reference to its predecessor except the first
	 * vertex of the path (null reference)
	 * 
	 * @param end
